package laya.webgl.shader.d2 {
	...
	public class Shader2X extends Shader {
		public var _params2dQuick2:*;
		public var _shaderValueWidth:Number;
		public var _shaderValueHeight:Number;

		public function Shader2X(vs:String = undefined,ps:String = undefined,saveName:* = undefined,nameMap:* = undefined,bindAttrib:* = undefined){}
		...
		public static function create(vs:String,ps:String,saveName:* = null,nameMap:* = null,bindAttrib:* = null):Shader{
			return null;
		}
	}
