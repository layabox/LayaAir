package laya.webgl.text {
	...
	public class CharRender_Native extends ICharRender {
		 ...
		 * @override 
		 */
		override public function getCharBmp(char:String,font:String,lineWidth:Number,colStr:String,strokeColStr:String,size:CharRenderInfo,margin_left:Number,margin_top:Number,margin_right:Number,margin_bottom:Number,rect:* = null):*{}
	}
