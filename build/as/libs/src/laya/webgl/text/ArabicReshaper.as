package laya.webgl.text {
	...
	public class ArabicReshaper {
		...
		public function getCombCharRep(c1:Number,c2:Number):Boolean{
			return null;
		}
		public function isTransparent(c:Number):Boolean{
			return null;
		}
		public function getOriginalCharsFromCode(code:Number):String{
			return null;
		}
