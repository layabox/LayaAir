package laya.d3.resource {
	...
	public class RenderTexture extends BaseTexture {
		 ...
		 * 从对象池获取临时渲染目标。
		 */
		public static function createFromPool(width:Number,height:Number,format:Number = null,depthStencilFormat:Number = null,mulSamples:Number = null):RenderTexture{
			return null;
		}
		...
		public function get mulSampler():Number{return null;}
		...
		public function RenderTexture(width:Number = undefined,height:Number = undefined,format:int = undefined,depthStencilFormat:int = undefined,mulSampler:Number = undefined){}
		 ...
		 * @return 像素数据。
		 */
		public function getData(x:Number,y:Number,width:Number,height:Number,out:*):*{}
