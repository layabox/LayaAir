package laya.d3.resource {
	...
	public class RenderTexture extends BaseTexture {
		 ...
		 * 从对象池获取临时渲染目标。
		 */
		public static function createFromPool(width:Number,height:Number,format:Number = null,depthStencilFormat:Number = null,filterMode:FilterMode = null):RenderTexture{
			return null;
		}
