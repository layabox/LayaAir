package laya.d3.core.material {
	...
	public class BlinnPhongMaterial extends Material {
		...
		private var _enableTransmission:*;
		 ...
		 * 是否支持顶点色。
		 */
		public function get enableTransmission():Boolean{return null;}
		public function set enableTransmission(value:Boolean):void{}

		/**
		 * 透光率，会影响漫反射以及透光强度
		 */
		public function get transmissionRate():Number{return null;}
		public function set transmissionRata(value:Number):void{}

		/**
		 * 透射影响范围指数
		 */
		public function get backDiffuse():Number{return null;}
		public function set backDiffuse(value:Number):void{}

		/**
		 * 透射光强度
		 */
		public function get backScale():Number{return null;}
		public function set backScale(value:Number):void{}

		/**
		 * 厚度贴图，会影响透视光，越厚，透射光越弱
		 */
		public function get thinknessTexture():BaseTexture{return null;}
		public function set thinknessTexture(value:BaseTexture):void{}

		/**
		 * 透光颜色。模拟透光物质内部颜色吸收率
		 */
		public function get transmissionColor():Vector4{return null;}
		public function set transmissionColor(value:Vector4):void{}
