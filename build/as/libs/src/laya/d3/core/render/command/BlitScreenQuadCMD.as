package laya.d3.core.render.command {
	...
	public class BlitScreenQuadCMD extends laya.d3.core.render.command.Command {
		...
		/*
		 */
		public static function create(source:BaseTexture,dest:RenderTexture,shader:Shader3D = null,shaderData:ShaderData = null,subShader:Number = null,screenType:Number = null):BlitScreenQuadCMD{
			return null;
		}
