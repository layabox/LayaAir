	...
	export class CartoonMaterial extends BaseMaterial {
		 ...
		 */
		 ...
		 static initShader():void {
			...
			var vs1:string = this.__INCLUDESTR__("shader/outline.vs");
			var ps1:string = this.__INCLUDESTR__("shader/outline.ps");
			var pass1:ShaderPass = subShader.addShaderPass(vs1, ps1);
			pass1.renderState.cull = RenderState.CULL_FRONT;
			
			var vs2:string = this.__INCLUDESTR__("shader/cartoon.vs");
			var ps2:string = this.__INCLUDESTR__("shader/cartoon.ps");
