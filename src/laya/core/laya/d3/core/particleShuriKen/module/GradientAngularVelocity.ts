...
import { IClone } from "../../IClone"
	...
	export class GradientAngularVelocity implements IClone {
		...
		/**@private */
		private _constantSeparate:Vector3;
		...
		/**@private */
		private _gradientW:GradientDataNumber;
		...
		/**@private */
		private _gradientWMin:GradientDataNumber;
		/**@private */
		private _gradientWMax:GradientDataNumber;
