...
import { Component } from "laya/components/Component"
	...
	export class Rigidbody3D extends PhysicsTriggerComponent {
		...
		private static _nativeVector3Zero:any = new Laya3D._physics3D.btVector3(0, 0, 0);
		private static _nativeInertia:any = new Laya3D._physics3D.btVector3(0, 0, 0);
		private static _nativeImpulse:any = new Laya3D._physics3D.btVector3(0, 0, 0);
		private static _nativeImpulseOffset:any = new Laya3D._physics3D.btVector3(0, 0, 0);
		private static _nativeGravity:any = new Laya3D._physics3D.btVector3(0, 0, 0);
