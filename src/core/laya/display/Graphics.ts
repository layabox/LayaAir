...
import { AlphaCmd } from "./cmd/AlphaCmd"
	...
	export class Graphics {
		 ...
		 */
		 drawTriangles(texture:Texture, x:number, y:number, vertices:Float32Array, uvs:Float32Array, indices:Uint16Array, matrix:Matrix = null, alpha:number = 1, color:string = null, blendMode:string = null):DrawTrianglesCmd {
