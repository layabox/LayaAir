/**
	...
	export class StatData {
		 ...
		 */
		 static clear():void {
			StatData.trianglesFaces = StatData.renderBatches = StatData.savedRenderBatches = StatData.shaderCall = StatData.spriteRenderUseCacheCount = StatData.frustumCulling = StatData.octreeNodeCulling = StatData.canvasNormal = StatData.canvasBitmap = StatData.canvasReCache = 0;
		}
