...
import { CustomMaterial } from "./customMaterials/CustomMaterial"
	...
	export class Shader_GlowingEdge {
		...
		private initShader():void {
			...
			var vs:string = this.__INCLUDESTR__("customShader/glowingEdgeShader.vs");
			var ps:string = this.__INCLUDESTR__("customShader/glowingEdgeShader.ps");
			//创建自定义shader
			...
			(<ShaderPass>subShader.addShaderPass(vs, ps) );
