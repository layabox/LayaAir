...
import { CameraMoveScript } from "../common/CameraMoveScript"
	...
	export class ResourceVersionDemo 
	{
		...
		constructor(){
			...
			ResourceVersion.enable("res/LayaScene_dudeScene/Conventional/version.json", Laya.Handler.create(this, this.onVersionLoaded), Laya.ResourceVersion.FILENAME_VERSION);
