...
import { CameraMoveScript } from "../common/CameraMoveScript"
	...
	import { VoxelLightRay } from "laya/d3Extend/vox/VoxelLightRay"
	import { VoxelLightSphere } from "laya/d3Extend/vox/VoxelLightSphere"
	...
	export class VoxelLight
	{
		 ...
		 testCube():void
		{
			...
			Laya.loader.load('nv.obj.lvox', Handler.create(null, function(arraybuffer:ArrayBuffer):void
			{
				...
				fmt2.decode(arraybuffer, {cb_setPalette: function(pal:Uint8Array):void
				{
					colorpal = pal;
