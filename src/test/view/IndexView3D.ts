...
import { Event } from "../laya/events/Event"
	...
	import { BoundingBoxTest } from "../3d/LayaAir3DTest__Experiment/BoundingBoxTest"
	import { GridTextureTest } from "../3d/LayaAir3DTest__Experiment/GridTextureTest"
	import { PickTexture } from "../3d/LayaAir3DTest__Experiment/PickTexture"
	import { PixGridSprite } from "../3d/LayaAir3DTest__Experiment/PixGridSprite"
	import { PixelTexture } from "../3d/LayaAir3DTest__Experiment/PixelTexture"
	import { Texture2DTest } from "../3d/LayaAir3DTest__Experiment/Texture2DTest"
	import { TextureExpandSprite } from "../3d/LayaAir3DTest__Experiment/TextureExpandSprite"
	import { AnimationEventByUnity } from "../3d/LayaAir3D_Animation/AnimationEventByUnity"
	import { AnimationLayerBlend } from "../3d/LayaAir3D_Animation/AnimationLayerBlend"
	import { AnimatorDemo } from "../3d/LayaAir3D_Animation/AnimatorDemo"
	import { AnimatorStateScriptDemo } from "../3d/LayaAir3D_Animation/AnimatorStateScriptDemo"
	import { BoneLinkSprite3D } from "../3d/LayaAir3D_Animation/BoneLinkSprite3D"
	import { CameraAnimation } from "../3d/LayaAir3D_Animation/CameraAnimation"
	import { MaterialAnimation } from "../3d/LayaAir3D_Animation/MaterialAnimation"
	import { RigidbodyAnimationDemo } from "../3d/LayaAir3D_Animation/RigidbodyAnimationDemo"
	import { SkinAnimationSample } from "../3d/LayaAir3D_Animation/SkinAnimationSample"
	...
	import { Particle_BurningGround } from "../3d/LayaAir3D_Particle/Particle_BurningGround"
	import { Particle_EternalLight } from "../3d/LayaAir3D_Particle/Particle_EternalLight"
	import { StaticBatchingTest } from "../3d/LayaAir3D_Performance/StaticBatchingTest"
	import { PhysicsWorld_BaseCollider } from "../3d/LayaAir3D_Physics/PhysicsWorld_BaseCollider"
	import { PhysicsWorld_BuildingBlocks } from "../3d/LayaAir3D_Physics/PhysicsWorld_BuildingBlocks"
	import { PhysicsWorld_Character } from "../3d/LayaAir3D_Physics/PhysicsWorld_Character"
	import { PhysicsWorld_CollisionFiflter } from "../3d/LayaAir3D_Physics/PhysicsWorld_CollisionFiflter"
	import { PhysicsWorld_CompoundCollider } from "../3d/LayaAir3D_Physics/PhysicsWorld_CompoundCollider"
	import { PhysicsWorld_ContinueCollisionDetection } from "../3d/LayaAir3D_Physics/PhysicsWorld_ContinueCollisionDetection"
	import { PhysicsWorld_Kinematic } from "../3d/LayaAir3D_Physics/PhysicsWorld_Kinematic"
	import { PhysicsWorld_MeshCollider } from "../3d/LayaAir3D_Physics/PhysicsWorld_MeshCollider"
	import { PhysicsWorld_RayShapeCast } from "../3d/LayaAir3D_Physics/PhysicsWorld_RayShapeCast"
	import { PhysicsWorld_TriggerAndCollisionEvent } from "../3d/LayaAir3D_Physics/PhysicsWorld_TriggerAndCollisionEvent"
	...
	import { Shader_CartoonRender } from "../LayaAir3D_Shader/Shader_CartoonRender"
	...
	import { ScriptSample } from "../LayaAir3D_Sprite3D/ScriptSample"
	...
	import { RenderTextureDemo } from "../3d/LayaAir3D_Texture/RenderTextureDemo"
	...
	export class IndexView3D extends IndexViewUI
	{
		...
		private  s:Secne3DPlayer2D
		private _advanceClsArr:any[] = [AStarFindPath,Laya3DCombineHtml,Scene2DPlayer3D,Secne3DPlayer2D];
		private _advanceArr:any[] = ['寻路组件','Laya3D与网页混合','2D坐标转3D坐标','3D坐标转2D坐标'];
		...
		private _shaderClsArr:any[] = [Shader_CartoonRender,Shader_GlowingEdge,Shader_Simple,Shader_Terrain];
		private _shaderArr:any[] = ['Shader_CartoonRender', 'Shader_GlowingEdge', 'Shader_Simple', "Shader_Terrain"];
		
		private _skyClsArr:any[] = [Sky_Procedural,Sky_SkyBox];
		private _skyArr:any[] = ['Sky_Procedural','Sky_SkyBox'];
		
		private _sprite3DClsArr:any[] = [PixelLineSprite3DDemo,ScriptSample,SkinnedMeshSprite3DDemo,Sprite3DClone,Sprite3DLoad,Sprite3DParent,TransformDemo];
		private _sprite3DArr:any[] = ['PixelLineSprite3D','ScriptSample', 'SkinnedMeshSprite3D',"Sprite3DClone",'Sprite3DLoad','Sprite3DParent','Transform'];
