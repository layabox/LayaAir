...
export class WebGraphicsRenderUnitPool {
    ...
    static recover(unit: WebGraphicsRenderUnit): void {
        ...
        // Pooled units retain their buffers, but must release texture references.
        if (unit.primitiveShaderData) {
            unit.primitiveShaderData.setTexture(ShaderDefines2D.UNIFORM_SPRITETEXTURE, null);
            unit.primitiveShaderData.setTexture(ShaderDefines2D.UNIFORM_SPRITETEXTURE_ARRAY, null);
        }
