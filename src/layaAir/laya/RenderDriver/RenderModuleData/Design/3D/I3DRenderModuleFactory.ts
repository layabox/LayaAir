...
import { IVolumetricGIData, IReflectionProbeData, ILightMapData, IDirectLightData, ISpotLightData, ICameraNodeData, ISceneNodeData, IBaseRenderNode, IMeshRenderNode, IPointLightData } from "./I3DRenderModuleData";
