...
export class WebGPUShaderCompileCode {
    ...
    private static _parameterNode: WebGPUShaderToken;
    ...
    private static __currNode: WebGPUShaderToken;
    /**当前刚刚设置过名字的Node，如果后面发现是个函数的话，直接给該node这是parameter属性 */
    private static _currNameNode: WebGPUShaderToken;
    /**当前的函数参数，或者函数调用的参数 */
    ...
    private static _struct: Record<string, WebGPUShaderToken>;
    ...
    private static set _currNode(value: WebGPUShaderToken) {
    ...
    static isEmptyNode(node: WebGPUShaderToken, isCheckParent = false) {
    ...
    private static _compileToTree(root: WebGPUShaderToken, script: string) {
