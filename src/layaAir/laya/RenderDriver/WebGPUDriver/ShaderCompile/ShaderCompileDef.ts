...
export class ShaderCompileDef {
    ...
    private static _currNode: ShaderToken;
    ...
    static isEmptyNode(node: ShaderToken) {
    ...
    private static _compileToTree(parent: ShaderToken, code: string) {
        ...
        if (text.indexOf("#") != 0) {
            ...
            switch (name) {
                ...
                case "#if":
                    ...
                    this._currNode = null;
                    ShaderCompileUtil.checkDef(node, this._defs);
                    break;
                case "#elif":
                case "#else":
                    this._parentNode = this._parentNode.parent;
