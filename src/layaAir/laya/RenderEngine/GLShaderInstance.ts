...
export class GLShaderInstance extends GLObject{
    ...
    */
     ...
     * @internal
     */
    _uniform_sampler2D(one: any, texture: any): number {//TODO:TEXTURTE ARRAY
        //TODO texture还未重构:
    ...
    _uniform_sampler3D(one: any, texture: any): number {//TODO:TEXTURTE ARRAY
        //TODO texture还未重构:
        var value: any = texture._getSource() || texture.defaulteTexture._getSource();
        var gl: WebGLRenderingContext = this._gl;
     ...
     * @internal
     */
    _uniform_samplerCube(one: any, texture: any): number {//TODO:TEXTURTECUBE ARRAY
        //TODO texture还未重构:
        var value: any = texture._getSource() || texture.defaulteTexture._getSource();
        var gl: WebGLRenderingContext = this._gl;
     ...
     * @internal
     */
    _bindTexture(textureID: number, target: number, texture: any): void {
        const gl = this._gl;
