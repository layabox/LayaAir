...
export class NativeGlBuffer extends NativeGLObject implements IRenderBuffer {
    //GLParams
    ...
    constructor(engine: NativeWebGLEngine, targetType: BufferTargetType, bufferUsageType: BufferUsage) {
        super(engine)
