...
export class NativeGLShaderInstance extends NativeGLObject implements IRenderShaderInstance{
    ...
    constructor(engine: NativeWebGLEngine, vs: string, ps: string, attributeMap: { [key: string]: number }) {
        super(engine);
        this._vs = vs;
        this._ps = ps;
