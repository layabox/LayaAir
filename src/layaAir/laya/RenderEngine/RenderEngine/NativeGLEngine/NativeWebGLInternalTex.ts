...
export class NativeWebGLInternalTex extends NativeGLObject implements InternalTexture {
    ...
    constructor(engine: NativeWebGLEngine, target: number, width: number, height: number, dimension: TextureDimension, mipmap: boolean, useSRGBLoader: boolean, gammaCorrection: number) {
        super(engine);
