...
export class AnimationClip extends Resource {
	 ...
	 */
	_evaluateClipDatasRealTime(nodes: KeyframeNodeList, playCurTime: number, realTimeCurrentFrameIndexes: Int16Array, addtive: boolean, frontPlay: boolean, outDatas: Array<boolean | number | string | Vector3 | Quaternion | Vector4 | Vector2 | { pos: Vector3, rotation: Vector3 }>, avatarMask: AvatarMask, skipTransform: boolean = false): void {
