...
import { URL } from "laya/net/URL";
	...
	export class MiniFileMgr{
		/**@private 读取文件操作接口**/
		private static fs:any = (<any>window).qq.getFileSystemManager();
		/**@private 下载文件接口**/
		private static wxdown:any = (<any>window).qq.downloadFile;
		/**@private 文件缓存列表**/
		...
		{
			for(var i:number = 0,sz:number = QQMiniAdapter.nativefiles.length;i<sz;i++)
			{
		...
		{
			var memSize:number = QQMiniAdapter.minClearSize;
