...
export class CameraDemo {
    ...
    private onPreLoadFinish(): void {
        ...
        let boxMesh: Mesh = PrimitiveMesh.createBox(0.5, 0.5, 0.5);
        let boxrender: MeshRenderer = box.addComponent(MeshRenderer);
        let boxfilter: MeshFilter = box.addComponent(MeshFilter);
