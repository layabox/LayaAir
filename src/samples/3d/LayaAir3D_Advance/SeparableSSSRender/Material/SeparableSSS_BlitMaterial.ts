...
import { MathUtils3D } from "laya/d3/math/MathUtils3D";
...
export class SeparableSSS_BlitMaterial extends Material{
	...
	static SHADERVALUE_SSSWIDTH:number = Shader3D.propertyNameToID("u_sssWidth");
	static SHADERVALUE_DISTANCETOPROJECTIONWINDOW:number = Shader3D.propertyNameToID("u_distanceToProjectionWindow");
	static SHADERVALUE_KENEL:number = Shader3D.propertyNameToID("u_kernel");
