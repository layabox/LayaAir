...
export class IndexView3D extends IndexViewUI {
    constructor() {
        ...
        this.btnOn = false;
        this._comboxBigArr2 = ['高级应用', '动画', '摄影机', '灯光', '材质', '网格', 'mouseLnteraction', '粒子系统', 'performance', '物理系统', 'resource', 'scene3D',
            'script', 'shader', 'sky', 'sprite3D', 'texture', 'trail'];
        //var s:Secne3DPlayer2D
        this._advanceClsArr = [Laya3DCombineHtml, Scene2DPlayer3D, Secne3DPlayer2D];
        this._advanceArr = ['Laya3D与网页混合', '2D坐标转3D坐标', '3D坐标转2D坐标'];
        this._animationClsArr = [AnimatorDemo, AnimatorStateScriptDemo, CameraAnimation, MaterialAnimation, SkinAnimationSample, AnimationEventByUnity, AnimationLayerBlend, BoneLinkSprite3D, RigidbodyAnimationDemo]; //AnimationEventByUnity,AnimationLayerBlend,BoneLinkSprite3D,RigidbodyAnimationDemo
        this._animationArr = ['Animator', "AnimatorStateScript", "CameraAnimation", "MaterialAnimation", "SkinAnimationSample", "AnimationEventByUnity", "AnimationLayerBlend", "BoneLinkSprite3D", "RigidbodyAnimation"];
        this._cameraClsArr = [CameraDemo, CameraLayer, CameraLookAt, CameraRay, D3SpaceToD2Space, MultiCamera, OrthographicCamera, RenderTargetCamera];
        this._cameraArr = ['Camera', 'CameraLayer', 'CameraLookAt', 'CameraRay', 'D3SpaceToD2Space', 'MultiCamera', 'OrthographicCamera', 'RenderTargetCamera'];
        this._lightingClsArr = [DirectionLightDemo, PointLightDemo, RealTimeShadow, SpotLightDemo];
        this._lightingArr = ['DirectionLight', 'PointLight', 'RealTimeShadow', 'SpotLight'];
        ...
        this._materilArr = ['BlinnPhong_DiffuseMap', 'BlinnPhong_NormalMap', "BlinnPhong_SpecularMap", "BlinnPhongMaterialLoad", "EffectMaterial", "Material", "PBRStandardMaterial", "UnlitMaterial", "WaterPrimaryMaterial"];
        this._meshClsArr = [ChangeMesh, CustomMesh, MeshLoad];
        this._meshArr = ['ChangeMesh', 'CustomMesh', "MeshLoad"];
        this._mouseLnteractionClsArr = [MouseInteraction, SceneLoad2, TouchScriptSample];
        this._mouseLnteractionArr = ['MouseInteraction', 'SceneLoad2', "TouchScriptSample"];
        ...
        this._performanceClsArr = [StaticBatchingTest];
        this._performanceArr = ['StaticBatchingTest'];
        ...
        this._resourceClsArr = [GarbageCollection, LoadResourceDemo];
        this._resourceArr = ['GarbageCollection', 'LoadResourceDemo'];
        this._scene3DClsArr = [EnvironmentalReflection, LightmapScene, SceneLoad1, SceneLoad2];
        this._scene3DArr = ['EnvironmentalReflection', 'LightmapScene', 'SceneLoad1', "SceneLoad2"];
        this._scriptClsArr = [ScriptDemo];
        this._scriptArr = ['ScriptDemo'];
        this._shaderClsArr = [Shader_MultiplePassOutline, Shader_GlowingEdge, Shader_Simple, Shader_Terrain];
        this._shaderArr = ['Shader_MultiplePassOutline', 'Shader_GlowingEdge', 'Shader_Simple', "Shader_Terrain"];
        ...
        this._textureClsArr = [TextureDemo, TextureGPUCompression];
        this._textureArr = ['Texture', 'TextureGPUCompression'];
    ...
    switchFunc(bigListIndex, smallListIndex) {
        this.btnOn = true;
        this.m_length = 0;
    ...
    onBigComBoxSelectHandler(index, smallIndex = 0) {
