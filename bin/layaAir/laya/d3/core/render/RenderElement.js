    ...
    _render(context, isTarget, customShader = null, replacementTag = null) {
        ...
        if (geometry._prepareRender(context)) {
            ...
            for (var j = 0, m = passes.length; j < m; j++) {
                var shaderPass = context.shader = passes[j].withCompile((scene._shaderValues._defineValue) & (~this.material._disablePublicDefineDatas.value), this.render._shaderValues._defineValue, this.material._shaderValues._defineValue);
