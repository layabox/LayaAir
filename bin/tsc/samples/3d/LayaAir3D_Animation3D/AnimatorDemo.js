...
export class AnimatorDemo {
    ...
    onLoadFinish() {
        ...
        //初始化胖子
        var pangzi = role.addChild(Loader.getRes("res/threeDimen/skinModel/BoneLinkScene/PangZi.lh"));
        //获取动画组件
    ...
    loadUI() {
        Laya.loader.load(["res/threeDimen/ui/button.png"], Handler.create(this, function () {
            ...
            this._changeActionButton.on(Event.CLICK, this, function () {
                this._PlayStopIndex++;
            ...
            this._changeActionButton2.on(Event.CLICK, this, function () {
                this._curStateIndex++;
