...
export class Sprite3DParent {
    ...
    onPreLoadFinish() {
        //添加父级猴子
        var layaMonkeyParent = this.scene.addChild(Loader.getRes("res/threeDimen/skinModel/LayaMonkey/LayaMonkey.lh"));
        //加载第二只猴子，作为子猴子
        var layaMonkeySon = Loader.getRes("res/threeDimen/skinModel/LayaMonkey2/LayaMonkey.lh");
