...
export class PickPixel {
    ...
    onMouseDown() {
        var posX = MouseManager.instance.mouseX;
        var posY = MouseManager.instance.mouseY;
    ...
    onComplete() {
        //加载场景
        var scene = Laya.stage.addChild(Loader.getRes("res/threeDimen/scene/CourtyardScene/Courtyard.ls"));
        //添加相机
