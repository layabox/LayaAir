...
export class IndexView3D extends IndexViewUI {
    constructor() {
        ...
        this._advanceClsArr = [PostProcessBloom, Laya3DCombineHtml, Scene2DPlayer3D, Secne3DPlayer2D];
        this._advanceArr = ['后期处理之泛光', 'Laya3D与网页混合', '2D坐标转3D坐标', '3D坐标转2D坐标'];
        ...
        this._mouseLnteractionClsArr = [MouseInteraction, MultiTouch, TouchScriptSample];
        this._mouseLnteractionArr = ['MouseInteraction', 'MultiTouch', "TouchScriptSample"];
